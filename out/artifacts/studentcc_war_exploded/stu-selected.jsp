...
<div align="center">
                    ...
                    <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center"
                        ...
                        <c:forEach items="${viewCT}" var="view" varStatus="ss">
                            <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';"
                                ...
                                <td bgcolor="#FFFFFF" align="center">
                                    <a href="${pageContext.request.contextPath}/studentServlet?cmd=tuike&id=${view.c_id}" style="color: red">退课</a>
                                </td>
    ...
    <table width='98%' border='0' style="margin-top:8px;margin-left: 11px;">
        <tr>
            ...
            <td>
                <input type="button" value="批量退课" style="width: 123px;" onclick="check()"/>
            </td>
        </tr>
    </table>
</div>
